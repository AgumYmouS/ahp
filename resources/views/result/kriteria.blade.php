        ...
        <div class="box box-primary">
            <div class="box-body">
                                ...
                                @foreach ($kriterias as $kraa => $vakra)
                                  ...
                                  @endphp
                                    ...
                                    @foreach ($arr as $key => $value)
                                      <h4>Hasil Perbandingan oleh <strong>{!! $vakra->nama_kriteria !!}</strong></h4>
                  ...
                  <div role="tab-panel" class="tab-pane" id="hasil">
                    @if (count($GLOBALS['bobotKriteriaList']) > 0 && count($GLOBALS['bobotPemasokList'])>0)
